				...
				<div class="row">
					...
					<div class="col-md-12 right-header">
						...
						<div style="float:right;">
							<p style="color:rgb(255,255,255);">Logged in User : <?php echo "$user_name"; ?></p>
							<form method="post">
							<button name="logout" class="btn btn-danger" style="float:right;">Logout</button>
							<a style="color: white; text-decoration: none;font-size: 16px;float:right;margin-right: 10px;margin-top : 5px;" href="./account_settings.php">Settings</a>
							</form>
						</div>
						<div class="right-header-img">
							<img src=/chat<?php echo"$user_profile_image";?> >
						</div>
				...
				<div class="row">
					<div class="col-md-12 right-chat-textbox">
						...
						<?php
   							...
   							$_SESSION['rand']=$rand;
						?>
						<input type="hidden" value="<?php echo $username ?>" name="loggedin_user" />
						<input type="hidden" value="<?php echo $user_name ?>" name="msg_receiver" />
