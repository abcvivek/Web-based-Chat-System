...
<div class="row">
  ...
  <?php 
      ...
      $forgotten_answer = $row['forgotten_answer'];
  ?>
  <div class="col-sm-8">
    <form action="" method="post" enctype="multipart/form-data">
                ...
                <div class="modal-dialog">
                  ...
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      ...
                      <input type="text" class="form-control" name="content" value="<?php echo $forgotten_answer;?>"><br/>
                      ...
                      if(isset($_POST['sub'])){
                        ...
                        echo "<script>alert('Success !! Your Best friend name is $bfn')</script>";
                        echo "<script>window.open('./account_settings.php?','_self')</script>";
                        }else{
        ...
        <?php
          ...
          $update = "update users set user_name='$user_name',user_email='$email',user_gender='$u_gender' where user_email='$user'";
