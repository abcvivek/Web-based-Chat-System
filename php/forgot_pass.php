...
<div class="signin-form">
    <form action="" method="post">
		...
		<div class="form-group">
			<label>Email</label>
        	<input type="text" class="form-control" placeholder="example@gmail.com" name="email" autocomplete="off" required="required">
        </div>
        <div class="form-group">
			<label>Bestfriend Name</label>
            <input type="text" class="form-control" placeholder="Answer..." name="bf" autocomplete="off" required="required">
        </div>
		<div class="form-group">
